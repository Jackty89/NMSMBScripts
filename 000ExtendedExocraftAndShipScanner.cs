...
public class ExtendedExocraftAndShipScanner : cmk.NMS.Script.ModClass
{
	...
	{
		var ExocraftNewScanEventsData = new string[][] {
			...
			new string[] {"DISTRESS_NPC",      "UI_PULSE_ENCOUNTER_NAME_REPAIR", "VEHICLE_SCAN1", "TEXTURES/UI/HUD/ICONS/MISSIONS/MISSION.REPAIR.DDS" },
