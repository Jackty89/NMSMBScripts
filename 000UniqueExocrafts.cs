...
public class UniqueExocrafts: cmk.NMS.Script.ModClass
{
	...
	protected GcInventoryLayoutSizeType.SizeTypeEnum[] VehicleSizes = new[]
		{
			...
			GcInventoryLayoutSizeType.SizeTypeEnum.VehicleMedium,
			GcInventoryLayoutSizeType.SizeTypeEnum.VehicleLarge
		};
	...
	protected void ChangeMechTechDamage()
	{
		...
		Cannon.StatBonuses.Find(BONUS => BONUS.Stat.StatsType == StatsTypeEnum.Vehicle_GunDamage).Bonus = MechSuitCanonDamange;
	}
}
